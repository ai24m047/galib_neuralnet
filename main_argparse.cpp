...
formats all hyperparameters into the required structure.
...
std::string buildPythonCommand(float learning_rate,
    ...
    std::filesystem::path scriptPath = " ../evol_neuralnet.py";

    // Build the command using string stream
    std::ostringstream cmd;
    cmd << pythonCmd << scriptPath.string()
